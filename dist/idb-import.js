        ...
        value: function createMergePatchSchema(schema, version) {
            ...
            this._setup(schema, version, function (e, db, transaction) {
                Object.keys(schema).forEach(function (storeName) {
                    ...
                    var store = void 0;
                    if (['key', 'keyPath', 'autoIncrement', 'copyFrom', 'moveFrom'].some(function (prop) {
        ...
        value: function createVersionedSchema(schemas, schemaType, clearUnusedStores, clearUnusedIndexes) {
            ...
            Object.keys(schemas || {}).sort().forEach(function (schemaVersion) {
                ...
                switch (schemaType) {
                    ...
                    case 'mixed':
                        {
                            schemaObj.forEach(function (mixedObj) {
                                ...
                                switch (schemaType) {
                                    ...
                                    case 'merge':
                                        {
                                            _this8.createMergePatchSchema(schema, version);
                                            break;
                                        }
                                    case 'whole':
                                        {
                                            _this8.createWholePatchSchema(schema, version, clearUnusedStores, clearUnusedIndexes);
                                            break;
                                        }
                                    default:
                    ...
                    case 'merge':
                        {
                            _this8.createMergePatchSchema(schemaObj, version);
                            break;
                        }
                    case 'whole':
                        {
                            _this8.createWholePatchSchema(schemaObj, version, clearUnusedStores, clearUnusedIndexes);
                            break;
                        }
                }
            });
