...
(function (local) {
    ...
    var Server = function Server(db, name, version, noServerMethods) {
        ...
        this.batch = function (storeOpsArr) {
            var opts = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : { extraStores: [], parallel: false };
        ...
        this.tableBatch = function (table, ops) {
            var opts = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : { parallel: false };
...
},{"./idb-import":2,"idb-batch":334}],2:[function(require,module,exports){
'use strict';
...
var IdbImport = function (_IdbSchema) {
    ...
    function IdbImport() {
        ...
        return _possibleConstructorReturn(this, (IdbImport.__proto__ || Object.getPrototypeOf(IdbImport)).call(this));
    }
    ...
    _createClass(IdbImport, [{
        ...
        value: function createMergePatchSchema(schema) {
            ...
            this._setup(schema, function (e, db, transaction) {
                Object.keys(schema).forEach(function (storeName) {
                    ...
                    var _createStoreIfNotSame2 = _this5._createStoreIfNotSame(db, transaction, schema, storeName, true),
                        _createStoreIfNotSame3 = _slicedToArray(_createStoreIfNotSame2, 1),
                    ...
                    if (hasOwn(schemaObj, 'indexes')) {
                        ...
                        if (_isNUL) {
                            _this5._deleteIndexes(transaction, storeName);
                            return;
                        }
                        ...
                        Object.keys(indexes).forEach(function (indexName) {
                            ...
                            _this5._createIndex(store, indexes, indexName, true);
                        });
                    }
                });
            });
        ...
        value: function createWholePatchSchema(schema) {
            ...
            this._setup(schema, function (e, db, transaction) {
                _this6._deleteAllUnused(db, transaction, schema, clearUnusedStores, clearUnusedIndexes);

                Object.keys(schema).forEach(function (storeName) {
                    var _createStoreIfNotSame4 = _this6._createStoreIfNotSame(db, transaction, schema, storeName),
                        _createStoreIfNotSame5 = _slicedToArray(_createStoreIfNotSame4, 2),
                        store = _createStoreIfNotSame5[0],
                        newStore = _createStoreIfNotSame5[1];

                    var indexes = newStore.indexes;
                    Object.keys(indexes || {}).forEach(function (indexName) {
                        _this6._createIndex(store, indexes, indexName);
                    });
                });
            });
        }
        ...
        value: function createVersionedSchema(schemas, schemaType, clearUnusedStores, clearUnusedIndexes) {
            ...
            var createPatches = function createPatches(schemaObj, schemaType) {
                switch (schemaType) {
                    case 'mixed':
                        {
                            schemaObj.forEach(function (mixedObj) {
                                ...
                                if (schemaType !== 'idb-schema' && schema === 'function') {
                                    schema = schema(_this7); // May throw
                                }
                                    ...
                                    case 'idb-schema':
                                        {
                                            ...
                                            _this7.createIdbSchemaPatchSchema(schema);
                                            break;
                                        }
                                    case 'merge':
                                        {
                                            _this7.createMergePatchSchema(schema);
                                            break;
                                        }
                                    case 'whole':
                                        {
                                            _this7.createWholePatchSchema(schema, clearUnusedStores, clearUnusedIndexes);
                                            break;
                                        }
                                    case 'mixed':
                                        {
                    ...
                    case 'merge':
                        {
                            _this7.createMergePatchSchema(schemaObj);
                            break;
                        }
                    case 'idb-schema':
                        {
                            _this7.createIdbSchemaPatchSchema(schemaObj);
                            break;
                        }
                    case 'whole':
                        {
                            _this7.createWholePatchSchema(schemaObj, clearUnusedStores, clearUnusedIndexes);
                            break;
                        }
                }
            };
            Object.keys(schemas || {}).sort().forEach(function (schemaVersion) {
                ...
                if (schemaType !== 'idb-schema' && typeof schemaObj === 'function') {
                    schemaObj = schemaObj(_this7); // May throw
                }
...
},{"idb-schema":336}],3:[function(require,module,exports){
(function (global){
"use strict";
...
},{"babel-polyfill":3,"is-plain-obj":337,"is-safari":338}],335:[function(require,module,exports){
(function (global){
'use strict';
...
},{"./idb-factory":335,"babel-polyfill":3,"is-plain-obj":337}],337:[function(require,module,exports){
'use strict';
